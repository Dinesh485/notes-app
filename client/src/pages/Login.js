...
const Login = () => {
    ...
    const handleGoogleLogin = () =>{
         axios.get('http://localhost:5000/google').then(res =>{
             console.log(res)
         })
    }
